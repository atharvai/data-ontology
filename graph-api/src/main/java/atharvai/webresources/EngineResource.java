...
public class EngineResource extends BaseResource {
    ...
    @POST
    public String executeScript(String script) throws ScriptException, JsonProcessingException {
        ...
        return this.mapper.writeValueAsString(IteratorUtils.asList(result));
    }
}
